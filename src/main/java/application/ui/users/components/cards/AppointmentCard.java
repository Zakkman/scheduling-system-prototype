...
public class AppointmentCard extends Card {
    ...
    private Component createContent(UserProfile<?> userProfile) {
        ...
        // Check if userProfile is null before adding it
        if (userProfile != null) {
            bodyLayout.add(userProfile);
        } else {
            // Add a placeholder component if the user profile is null
